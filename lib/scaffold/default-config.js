...
/**
 * Will return the path and default ltc-node configuration. It will search for the
 * configuration file in the "~/.ltc" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.ltc');
  var defaultConfigFile = path.resolve(defaultPath, './ltc-node.json');
