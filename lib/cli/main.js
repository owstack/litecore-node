...
function main(servicesPath, additionalServices) {
  ...
  var version = ltcnode.version;
  var create = ltcnode.scaffold.create;
  var add = ltcnode.scaffold.add;
  var start = ltcnode.scaffold.start;
  var remove = ltcnode.scaffold.remove;
  var callMethod = ltcnode.scaffold.callMethod;
  var findConfig = ltcnode.scaffold.findConfig;
  var defaultConfig = ltcnode.scaffold.defaultConfig;
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `ltc-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ ltc-node add wallet-service');
      console.log('    $ ltc-node add explorer-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ ltc-node remove wallet-service');
      console.log('    $ ltc-node remove explorer-api');
      console.log();
    });
